...
const checkboxIndicatorStyle = tva({
   base: "justify-center items-center border-custom-sub bg-transparent rounded web:data-[focus-visible=true]:outline-none web:data-[focus-visible=true]:ring-2 web:data-[focus-visible=true]:ring-indicator-primary data-[checked=true]:bg-custom-point data-[checked=true]:border-custom-point data-[hover=true]:data-[checked=false]:border-outline-500 data-[hover=true]:bg-transparent data-[hover=true]:data-[invalid=true]:border-error-700 data-[hover=true]:data-[checked=true]:bg-custom-point-hover data-[hover=true]:data-[checked=true]:border-custom-point-hover data-[hover=true]:data-[checked=true]:data-[disabled=true]:border-custom-sub data-[hover=true]:data-[checked=true]:data-[disabled=true]:bg-custom-sub data-[hover=true]:data-[checked=true]:data-[disabled=true]:opacity-40 data-[hover=true]:data-[checked=true]:data-[disabled=true]:data-[invalid=true]:border-error-700 data-[hover=true]:data-[disabled=true]:border-outline-400 data-[hover=true]:data-[disabled=true]:data-[invalid=true]:border-error-700 data-[active=true]:data-[checked=true]:bg-custom-point-active data-[active=true]:data-[checked=true]:border-custom-point-active data-[invalid=true]:border-error-700 data-[disabled=true]:opacity-40",
   parentVariants: {
      size: {
         lg: "w-6 h-6 border-2",
         md: "w-5 h-5 border-2",
