...
const buttonStyle = tva({
   ...
   variants: {
      action: {
         ...
         point: "bg-custom-point border-none data-[hover=true]:bg-custom-point-hover data-[active=true]:bg-custom-point-active data-[focus-visible=true]:web:ring-indicator-info",
         "point-light":
            "bg-custom-point-light border-none data-[hover=true]:bg-custom-point data-[active=true]:bg-custom-point-hover data-[focus-visible=true]:web:ring-indicator-info",
      },
      variant: {
         link: "px-0",
         outline:
      ...
      size: {
         xs: "px-[9.5px] py-[4px] h-fit",
         sm: "px-4 h-9",
         md: "px-5 py-[16px] h-fit rounded-[8px]",
         lg: "px-6 py-[22.5px] h-fit rounded-[12px]",
         xl: "px-7 h-12",
      },
   },
   compoundVariants: [
...
const buttonTextStyle = tva({
   ...
   parentVariants: {
      action: {
         ...
         point: "text-custom-point data-[hover=true]:text-custom-point data-[active=true]:text-custom-point",
      },
      variant: {
